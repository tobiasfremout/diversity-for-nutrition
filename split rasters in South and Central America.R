...
cat("presence maps masked by hull")
...
cat("presence maps not masked by hull")
...
cat("future masked by hull - SSP2")
...
cat("future masked by hull - SSP3")
...
cat("future not masked by hull - SSP2")
...
cat("future not masked by hull - SSP3")
